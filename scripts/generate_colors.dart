...
String _generateFlyColorsFile(
  ...
  buffer.writeln('///   FlyColor.amber (seed/base color - step 9)');
  buffer.writeln('///   FlyColor.amber1 (light mode - direct access)');
  buffer.writeln('///   FlyColor.amber1Dark (dark mode - direct access)');
  buffer.writeln('///   FlyColorLight.amber1 (light mode - direct access)');
  buffer.writeln('///   FlyColorDark.amber1 (dark mode - direct access)');
  buffer.writeln('///   FlyColor.of(context).amber1 (context-aware)');
  buffer.writeln('');
  ...
  buffer.writeln('/// the current theme context.');
